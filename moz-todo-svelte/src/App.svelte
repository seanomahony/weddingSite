...
<footer>
	<img src="/resources/bottom sparkle.png" alt="Bottom of page sparkle" width="200"/>
</footer>
...
@font-face{
  ...
  src: url('/resources/euphoria/EuphoriaScript-Regular.ttf') format('truetype');
}
